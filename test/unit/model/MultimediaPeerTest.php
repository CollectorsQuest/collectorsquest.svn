...
$images = array(
  sfConfig::get('sf_data_dir').'/test/multimedia/05620d783231c09402ea1d406d35a58c.jpg',
  sfConfig::get('sf_data_dir').'/test/multimedia/787d7bfb4d440de2ef136f097683f426.jpg',
  sfConfig::get('sf_data_dir').'/test/multimedia/c71794c2b0bf9fd8a9cd31abda2ed70b.jpg',
  sfConfig::get('sf_data_dir').'/test/multimedia/4fbe6dbd481c49c4eab4a2f12e7808f9.jpg',
  sfConfig::get('sf_data_dir').'/test/multimedia/38eb5d37b931b5c7c6429bc07600fbb9.jpg',
  sfConfig::get('sf_data_dir').'/test/multimedia/collectible-1911.jpg',
  sfConfig::get('sf_data_dir').'/test/multimedia/collectible-31.jpg',
  sfConfig::get('sf_data_dir').'/test/multimedia/collectible-1357.jpg'
);
