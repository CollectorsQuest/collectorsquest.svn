...
class PayPal
{
	...
	public function __construct($API_USERNAME, $API_PASSWORD, $API_SIGNATURE, $API_URL,  $IS_ONLINE , $PROXY_HOST = '', $PROXY_PORT = '', $USE_PROXY = FALSE, $VERSION = '57.0')
	{
