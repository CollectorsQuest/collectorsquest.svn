...
/**
 * This class defines the structure of the 'multimedia_archive' table.
 *
 *
 *
 ...
 */
class MultimediaArchiveTableMap extends TableMap
{

  /**
   * The (dot-path) name of this class
   */
  const CLASS_NAME = 'lib.model.archive.map.MultimediaArchiveTableMap';
  ...
  {
    // attributes
    $this->setName('multimedia_archive');
    $this->setPhpName('MultimediaArchive');
    $this->setClassname('MultimediaArchive');
