...
class CollectibleOfferArchiveTableMap extends TableMap
{
   ...
   */
  const CLASS_NAME = 'lib.model.archive.map.CollectibleOfferArchiveTableMap';
  ...
  public function initialize()
  {
    ...
    $this->addColumn('COLLECTIBLE_FOR_SALE_ID', 'CollectibleForSaleId', 'INTEGER', false, null, null);
