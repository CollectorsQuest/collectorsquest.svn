...
/**
 * Base class that represents a row from the 'collectible_offer_archive' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.archive.om
 */
abstract class BaseCollectibleOfferArchive extends BaseObject  implements Persistent
{

  /**
   * Peer class name
   */
  const PEER = 'CollectibleOfferArchivePeer';

  /**
   * The Peer class.
   * Instance provides a convenient way of calling static methods on a class
   * that calling code may not be able to identify.
   * @var        CollectibleOfferArchivePeer
   */
  ...
  public function setId($v)
  {
    ...
    {
      $this->id = $v;
      $this->modifiedColumns[] = CollectibleOfferArchivePeer::ID;
    }
  ...
  public function setCollectibleId($v)
  {
    ...
    if ($this->collectible_id !== $v)
    {
      ...
      $this->modifiedColumns[] = CollectibleOfferArchivePeer::COLLECTIBLE_ID;
    }
  ...
  public function setCollectibleForSaleId($v)
  {
    ...
    if ($this->collectible_for_sale_id !== $v)
    {
      ...
      $this->modifiedColumns[] = CollectibleOfferArchivePeer::COLLECTIBLE_FOR_SALE_ID;
    }
  ...
  public function setCollectorId($v)
  {
    ...
    {
      $this->collector_id = $v;
      $this->modifiedColumns[] = CollectibleOfferArchivePeer::COLLECTOR_ID;
    }
  ...
  public function setPrice($v)
  {
    ...
    {
      $this->price = $v;
      $this->modifiedColumns[] = CollectibleOfferArchivePeer::PRICE;
    }
  ...
  public function setStatus($v)
  {
    ...
    {
      $this->status = $v;
      $this->modifiedColumns[] = CollectibleOfferArchivePeer::STATUS;
    }
  ...
  public function setUpdatedAt($v)
  {
    ...
    if ($this->updated_at !== null || $dt !== null)
    {
      ...
      if ($currentDateAsString !== $newDateAsString)
      {
        ...
        $this->modifiedColumns[] = CollectibleOfferArchivePeer::UPDATED_AT;
      }
    }
  ...
  public function setCreatedAt($v)
  {
    ...
    if ($this->created_at !== null || $dt !== null)
    {
      ...
      if ($currentDateAsString !== $newDateAsString)
      {
        ...
        $this->modifiedColumns[] = CollectibleOfferArchivePeer::CREATED_AT;
      }
    }
  ...
  public function setArchivedAt($v)
  {
    ...
    if ($this->archived_at !== null || $dt !== null)
    {
      ...
      if ($currentDateAsString !== $newDateAsString)
      {
        ...
        $this->modifiedColumns[] = CollectibleOfferArchivePeer::ARCHIVED_AT;
      }
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    ...
    {
      throw new PropelException("Error populating CollectibleOfferArchive object", $e);
    }
  }
  ...
  public function reload($deep = false, PropelPDO $con = null)
  {
    ...
    $stmt = CollectibleOfferArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
  ...
  public function delete(PropelPDO $con = null)
  {
    ...
    try
    {
      $deleteQuery = CollectibleOfferArchiveQuery::create()
        ->filterByPrimaryKey($this->getPrimaryKey());
      $ret = $this->preDelete($con);
      // symfony_behaviors behavior
      foreach (sfMixer::getCallables('BaseCollectibleOfferArchive:delete:pre') as $callable)
      {
      ...
      if ($ret)
      {
        ...
        $this->postDelete($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BaseCollectibleOfferArchive:delete:post') as $callable)
        {
  ...
  public function save(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      // symfony_behaviors behavior
      foreach (sfMixer::getCallables('BaseCollectibleOfferArchive:save:pre') as $callable)
      {
      ...
      if ($this->isModified() && !$this->isColumnModified(CollectibleOfferArchivePeer::UPDATED_AT))
      {
      ...
      if ($ret)
      {
        ...
        $this->postSave($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BaseCollectibleOfferArchive:save:post') as $callable)
        {
          call_user_func($callable, $this, $con, $affectedRows);
        }

        CollectibleOfferArchivePeer::addInstanceToPool($this);
      }
      else
      {
        $affectedRows = 0;
  ...
  protected function doValidate($columns = null)
  {
    if (!$this->alreadyInValidation)
    {
      ...
      if (($retval = CollectibleOfferArchivePeer::doValidate($this, $columns)) !== true)
      {
  ...
  {
    $pos = CollectibleOfferArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
  ...
  {
    if (isset($alreadyDumpedObjects['CollectibleOfferArchive'][$this->getPrimaryKey()]))
    {
      return '*RECURSION*';
    }
    $alreadyDumpedObjects['CollectibleOfferArchive'][$this->getPrimaryKey()] = true;
    $keys = CollectibleOfferArchivePeer::getFieldNames($keyType);
    $result = array(
      $keys[0] => $this->getId(),
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(CollectibleOfferArchivePeer::ID)) $criteria->add(CollectibleOfferArchivePeer::ID, $this->id);
    if ($this->isColumnModified(CollectibleOfferArchivePeer::COLLECTIBLE_ID)) $criteria->add(CollectibleOfferArchivePeer::COLLECTIBLE_ID, $this->collectible_id);
    if ($this->isColumnModified(CollectibleOfferArchivePeer::COLLECTIBLE_FOR_SALE_ID)) $criteria->add(CollectibleOfferArchivePeer::COLLECTIBLE_FOR_SALE_ID, $this->collectible_for_sale_id);
  ...
  {
    $criteria = new Criteria(CollectibleOfferArchivePeer::DATABASE_NAME);
    $criteria->add(CollectibleOfferArchivePeer::ID, $this->id);
   ...
   * objects.
   *
   * @param      object $copyObj An object of CollectibleOfferArchive (or compatible) type.
   ...
   *
   * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
   * @return     CollectibleOfferArchive Clone of current object.
   * @throws     PropelException
   */
   ...
   *
   * @return     CollectibleOfferArchivePeer
   */
  public function getPeer()
  {
    if (self::$peer === null)
    {
      self::$peer = new CollectibleOfferArchivePeer();
    }
    return self::$peer;
  }
  ...
  {
    return (string) $this->exportTo(CollectibleOfferArchivePeer::DEFAULT_STRING_FORMAT);
  }
  ...
  public function __call($name, $params)
  {
    ...
    // symfony_behaviors behavior
    if ($callable = sfMixer::getCallable('BaseCollectibleOfferArchive:' . $name))
    {
