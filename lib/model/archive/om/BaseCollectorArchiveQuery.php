...
abstract class BaseCollectorArchiveQuery extends ModelCriteria
{
  ...
  public function findPk($key, $con = null)
  {
    ...
    if ((null !== ($obj = CollectorArchivePeer::getInstanceFromPool((string) $key))) && !$this->formatter)
    {
  ...
  protected function findPkSimple($key, $con)
  {
    ...
    {
      $obj = new CollectorArchive();
      $obj->hydrate($row);
      CollectorArchivePeer::addInstanceToPool($obj, (string) $row[0]);
    }
    $stmt->closeCursor();
