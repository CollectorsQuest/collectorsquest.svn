...
abstract class BaseCollectorArchivePeer
{
  ...
  const CLASS_DEFAULT = 'lib.model.archive.CollectorArchive';
  ...
  const GRAPH_ID = 'collector_archive.GRAPH_ID';
  ...
  const CREATED_AT = 'collector_archive.CREATED_AT';
  ...
  public static function addSelectColumns(Criteria $criteria, $alias = null)
  {
    if (null === $alias)
    {
      ...
      $criteria->addSelectColumn(CollectorArchivePeer::GRAPH_ID);
      ...
      $criteria->addSelectColumn(CollectorArchivePeer::LOCALE);
      $criteria->addSelectColumn(CollectorArchivePeer::SCORE);
      $criteria->addSelectColumn(CollectorArchivePeer::SPAM_SCORE);
      $criteria->addSelectColumn(CollectorArchivePeer::IS_SPAM);
