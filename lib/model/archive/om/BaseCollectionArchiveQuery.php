 ...
 * @method     CollectionArchiveQuery orderByGraphId($order = Criteria::ASC) Order by the graph_id column
 ...
 * @method     CollectionArchiveQuery groupByGraphId() Group by the graph_id column
 ...
 * @method     CollectionArchive findOneByGraphId(int $graph_id) Return the first CollectionArchive filtered by the graph_id column
 ...
 * @method     array findByGraphId(int $graph_id) Return CollectionArchive objects filtered by the graph_id column
...
abstract class BaseCollectionArchiveQuery extends ModelCriteria
{
   ...
   */
  public function __construct($dbName = 'archive', $modelName = 'CollectionArchive', $modelAlias = null)
  {
  ...
  public function findPk($key, $con = null)
  {
    ...
    if ((null !== ($obj = CollectionArchivePeer::getInstanceFromPool((string) $key))) && !$this->formatter)
    {
   ...
   *
   * @return    CollectionArchive A model object, or null if the key is not found
   */
  protected function findPkSimple($key, $con)
  {
    $sql = 'SELECT `ID`, `GRAPH_ID`, `COLLECTION_CATEGORY_ID`, `COLLECTOR_ID`, `NAME`, `SLUG`, `DESCRIPTION`, `NUM_ITEMS`, `NUM_VIEWS`, `NUM_COMMENTS`, `NUM_RATINGS`, `SCORE`, `IS_PUBLIC`, `IS_FEATURED`, `COMMENTS_ON`, `RATING_ON`, `EBLOB`, `UPDATED_AT`, `CREATED_AT`, `ARCHIVED_AT` FROM `collection_archive` WHERE `ID` = :p0';
    try
    {
    ...
    {
      $obj = new CollectionArchive();
      $obj->hydrate($row);
      CollectionArchivePeer::addInstanceToPool($obj, (string) $row[0]);
    }
    $stmt->closeCursor();
  ...
  public function filterByGraphId($graphId = null, $comparison = null)
  {
    if (is_array($graphId))
    {
      ...
      {
        $this->addUsingAlias(CollectionArchivePeer::GRAPH_ID, $graphId['min'], Criteria::GREATER_EQUAL);
        $useMinMax = true;
      }
      if (isset($graphId['max']))
      {
        $this->addUsingAlias(CollectionArchivePeer::GRAPH_ID, $graphId['max'], Criteria::LESS_EQUAL);
        $useMinMax = true;
      }
      if ($useMinMax)
      {
    ...
    return $this->addUsingAlias(CollectionArchivePeer::GRAPH_ID, $graphId, $comparison);
  }
  ...
  public function filterByUpdatedAt($updatedAt = null, $comparison = null)
  {
    if (is_array($updatedAt))
    {
      ...
      {
        $this->addUsingAlias(CollectionArchivePeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
        $useMinMax = true;
      }
      if (isset($updatedAt['max']))
      {
        $this->addUsingAlias(CollectionArchivePeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
        $useMinMax = true;
      }
      if ($useMinMax)
      {
    ...
    return $this->addUsingAlias(CollectionArchivePeer::UPDATED_AT, $updatedAt, $comparison);
  }
  ...
  public function filterByCreatedAt($createdAt = null, $comparison = null)
  {
    if (is_array($createdAt))
    {
      ...
      {
        $this->addUsingAlias(CollectionArchivePeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
        $useMinMax = true;
      }
      if (isset($createdAt['max']))
      {
        $this->addUsingAlias(CollectionArchivePeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
        $useMinMax = true;
      }
      if ($useMinMax)
      {
    ...
    return $this->addUsingAlias(CollectionArchivePeer::CREATED_AT, $createdAt, $comparison);
  }
