...
abstract class BasewpComment extends BaseObject  implements Persistent
{
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      $this->comment_author = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
      $this->comment_author_email = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
      $this->comment_date = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
      $this->resetModified();
    ...
    if (!$this->alreadyInSave)
    {
      ...
      if ($this->isModified())
      {
        if ($this->isNew())
        {
          ...
          if ($criteria->keyContainsValue(wpCommentPeer::COMMENT_ID) )
          {
        ...
        {
          $affectedRows = wpCommentPeer::doUpdate($this, $con);
        }
  ...
  public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
  {
    ...
    $result = array(
      ...
      $keys[1] => $this->getCommentAuthor(),
      $keys[2] => $this->getCommentAuthorEmail(),
      $keys[3] => $this->getCommentDate(),
    );
    return $result;
  }
  ...
  public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
  {
    ...
    if (array_key_exists($keys[1], $arr)) $this->setCommentAuthor($arr[$keys[1]]);
    if (array_key_exists($keys[2], $arr)) $this->setCommentAuthorEmail($arr[$keys[2]]);
    if (array_key_exists($keys[3], $arr)) $this->setCommentDate($arr[$keys[3]]);
  }
