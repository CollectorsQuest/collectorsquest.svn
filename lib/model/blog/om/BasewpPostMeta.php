...
abstract class BasewpPostMeta extends BaseObject  implements Persistent
{
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      return $startcol + 4; // 4 = wpPostMetaPeer::NUM_COLUMNS - wpPostMetaPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function ensureConsistency()
  {
    ...
    if ($this->awpPost !== null && $this->post_id !== $this->awpPost->getId())
    {
      $this->awpPost = null;
    }
  }
  ...
  public function delete(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      foreach (sfMixer::getCallables('BasewpPostMeta:delete:pre') as $callable)
      {
      ...
      if ($ret)
      {
        ...
        $this->postDelete($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BasewpPostMeta:delete:post') as $callable)
        {
  ...
  public function save(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      // symfony_behaviors behavior
      foreach (sfMixer::getCallables('BasewpPostMeta:save:pre') as $callable)
      {
      ...
      if ($ret)
      {
        ...
        $this->postSave($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BasewpPostMeta:save:post') as $callable)
        {
    ...
    if (!$this->alreadyInSave)
    {
      ...
      if ($this->isModified())
      {
        if ($this->isNew())
        {
          ...
          if ($criteria->keyContainsValue(wpPostMetaPeer::META_ID) )
          {
          ...
          $affectedRows += 1;
          $this->setMetaId($pk);  //[IMV] update autoincrement primary key
          $this->setNew(false);
        }
        else
        {
          $affectedRows += wpPostMetaPeer::doUpdate($this, $con);
        }
  ...
  public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
  {
    ...
    if ($includeForeignObjects)
    {
      ...
      {
        $result['wpPost'] = $this->awpPost->toArray($keyType, $includeLazyLoadColumns, true);
      }
    }
    return $result;
  }
  ...
  {
    if ($this->awpPost === null && ($this->post_id !== null))
    {
      $this->awpPost = wpPostQuery::create()->findPk($this->post_id, $con);
      /* The following can be used additionally to
         guarantee the related object contains a reference
         to this object.  This level of coupling may, however, be
         undesirable since it could result in an only partially populated collection
         in the referenced object.
         $this->awpPost->addwpPostMetas($this);
       */
    }
    return $this->awpPost;
  }
  ...
  {
    // symfony_behaviors behavior
    if ($callable = sfMixer::getCallable('BasewpPostMeta:' . $name))
    {
