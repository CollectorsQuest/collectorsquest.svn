...
/**
 * This class defines the structure of the 'custom_field' table.
 *
 *
 *
 ...
 */
class CustomFieldTableMap extends TableMap
{

  /**
   * The (dot-path) name of this class
   */
  const CLASS_NAME = 'lib.model.map.CustomFieldTableMap';
  ...
  {
    // attributes
    $this->setName('custom_field');
    $this->setPhpName('CustomField');
    $this->setClassname('CustomField');
