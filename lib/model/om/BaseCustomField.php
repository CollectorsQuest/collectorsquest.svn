...
/**
 * Base class that represents a row from the 'custom_field' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseCustomField extends BaseObject  implements Persistent
{

  /**
   * Peer class name
   */
  const PEER = 'CustomFieldPeer';
  ...
  /**
   * Get the [validation] column value.
   * 
   * @return     string
   */
  ...
  public function setName($v)
  {
    ...
    {
      $this->name = $v;
      $this->modifiedColumns[] = CustomFieldPeer::NAME;
    }
  ...
  public function setType($v)
  {
    ...
    {
      $this->type = $v;
      $this->modifiedColumns[] = CustomFieldPeer::TYPE;
    }
  ...
  public function setObject($v)
  {
    ...
    {
      $this->object = $v;
      $this->modifiedColumns[] = CustomFieldPeer::OBJECT;
    }
  ...
  /**
   * Set the value of [validation] column.
   * 
   * @param      string $v new value
   * @return     CustomField The current object (for fluent API support)
   */
  public function setValidation($v)
  {
    ...
    {
      $this->validation = $v;
      $this->modifiedColumns[] = CustomFieldPeer::VALIDATION;
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      $this->validation = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
      $this->resetModified();
    ...
    {
      throw new PropelException("Error populating CustomField object", $e);
    }
  }
  ...
  public function reload($deep = false, PropelPDO $con = null)
  {
    ...
    $stmt = CustomFieldPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
  ...
  public function save(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      // symfony_behaviors behavior
      foreach (sfMixer::getCallables('BaseCustomField:save:pre') as $callable)
      {
      ...
      if ($ret)
      {
        ...
        $this->postSave($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BaseCustomField:save:post') as $callable)
        {
          call_user_func($callable, $this, $con, $affectedRows);
        }

        CustomFieldPeer::addInstanceToPool($this);
      }
      else
      {
        $affectedRows = 0;
  ...
  protected function doValidate($columns = null)
  {
    if (!$this->alreadyInValidation)
    {
      ...
      if (($retval = CustomFieldPeer::doValidate($this, $columns)) !== true)
      {
  ...
  {
    $pos = CustomFieldPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
  ...
  public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
  {
    ...
    if (array_key_exists($keys[4], $arr)) $this->setValidation($arr[$keys[4]]);
  }
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(CustomFieldPeer::ID)) $criteria->add(CustomFieldPeer::ID, $this->id);
    if ($this->isColumnModified(CustomFieldPeer::NAME)) $criteria->add(CustomFieldPeer::NAME, $this->name);
    if ($this->isColumnModified(CustomFieldPeer::TYPE)) $criteria->add(CustomFieldPeer::TYPE, $this->type);
    if ($this->isColumnModified(CustomFieldPeer::OBJECT)) $criteria->add(CustomFieldPeer::OBJECT, $this->object);
    if ($this->isColumnModified(CustomFieldPeer::VALIDATION)) $criteria->add(CustomFieldPeer::VALIDATION, $this->validation);
  ...
  {
    $criteria = new Criteria(CustomFieldPeer::DATABASE_NAME);
    $criteria->add(CustomFieldPeer::ID, $this->id);
   ...
   *
   * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
   * @return     CustomField Clone of current object.
   * @throws     PropelException
   */
   ...
   *
   * @return     CustomFieldPeer
   */
  public function getPeer()
  {
    if (self::$peer === null)
    {
      self::$peer = new CustomFieldPeer();
    }
    return self::$peer;
  }
   ...
   * If this CustomField is new, it will return
   ...
   * Otherwise if this CustomField is new, it will return
   * an empty collection; or if this CustomField has previously
   * been saved, it will retrieve related CollectionCategoryFields from storage.
   *
   * This method is protected by default in order to keep the public
   * api reasonable.  You can provide public methods for those you
   * actually need in CustomField.
   *
   * @param      Criteria $criteria optional Criteria object to narrow the query
   * @param      PropelPDO $con optional connection object
   ...
   * @return     PropelCollection|array CollectionCategoryField[] List of CollectionCategoryField objects
   */
  public function getCollectionCategoryFieldsJoinCollectionCategory($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
  {
    $query = CollectionCategoryFieldQuery::create(null, $criteria);
