...
/**
 * Base static class for performing query and update operations on the 'collection_category' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseCollectionCategoryPeer
{
  ...
  const TABLE_NAME = 'collection_category';

  /** the related Propel class for this table */
  const OM_CLASS = 'CollectionCategory';

  /** A class that can be returned by this peer. */
  const CLASS_DEFAULT = 'lib.model.CollectionCategory';
  ...
  const PARENT_ID = 'collection_category.PARENT_ID';
   ...
   * @param      string $column The column name for current table. (i.e. CollectionCategoryPeer::COLUMN_NAME).
   * @return     string
   */
  public static function alias($alias, $column)
  {
    return str_replace(CollectionCategoryPeer::TABLE_NAME.'.', $alias.'.', $column);
  }
  ...
  public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
  {
    ...
    $criteria->setPrimaryTableName(CollectionCategoryPeer::TABLE_NAME);
    ...
    {
      call_user_func($sf_hook, 'BaseCollectionCategoryPeer', $criteria, $con);
    }
  ...
  public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
  {
    ...
    $critcopy->setLimit(1);
    $objects = CollectionCategoryPeer::doSelect($critcopy, $con);
    if ($objects)
    {
      return $objects[0];
    }
  ...
  {
    return CollectionCategoryPeer::populateObjects(CollectionCategoryPeer::doSelectStmt($criteria, $con));
  }
  /**
   ...
   *
   * @param      mixed $value A CollectionCategory object or a primary key value.
   */
  public static function removeInstanceFromPool($value)
  {
    if (Propel::isInstancePoolingEnabled() && $value !== null)
    {
      if (is_object($value) && $value instanceof CollectionCategory)
      {
      ...
      {
        $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or CollectionCategory object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
        throw $e;
      }
   ...
   * @return     CollectionCategory Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
  ...
  /**
   * Method to invalidate the instance pool of all tables related to collection_category
  ...
  public static function populateObjects(PDOStatement $stmt)
  {
    ...
    {
      $key = CollectionCategoryPeer::getPrimaryKeyHashFromRow($row, 0);
      if (null !== ($obj = CollectionCategoryPeer::getInstanceFromPool($key)))
      {
      ...
      else
      {
        ...
        $obj->hydrate($row);
        $results[] = $obj;
        CollectionCategoryPeer::addInstanceToPool($obj, $key);
      }
    }
    $stmt->closeCursor();
    return $results;
   ...
   * @throws     PropelException Any exceptions caught during processing will be
   *     rethrown wrapped into a PropelException.
   * @return     array (CollectionCategory object, last column rank)
   */
  public static function populateObject($row, $startcol = 0)
  {
    $key = CollectionCategoryPeer::getPrimaryKeyHashFromRow($row, $startcol);
    if (null !== ($obj = CollectionCategoryPeer::getInstanceFromPool($key)))
    {
      // We no longer rehydrate the object, since this can cause data loss.
      // See http://www.propelorm.org/ticket/509
    ...
    {
      $cls = CollectionCategoryPeer::OM_CLASS;
      $obj = new $cls();
  ...
  {
    $dbMap = Propel::getDatabaseMap(BaseCollectionCategoryPeer::DATABASE_NAME);
    if (!$dbMap->hasTable(BaseCollectionCategoryPeer::TABLE_NAME))
    {
      $dbMap->addTableObject(new CollectionCategoryTableMap());
    }
  }
  ...
  {
    return $withPrefix ? CollectionCategoryPeer::CLASS_DEFAULT : CollectionCategoryPeer::OM_CLASS;
  }
  ...
  public static function doUpdate($values, PropelPDO $con = null)
  {
    ...
    if ($values instanceof Criteria)
    {
      ...
      $comparison = $criteria->getComparison(CollectionCategoryPeer::ID);
      $value = $criteria->remove(CollectionCategoryPeer::ID);
      if ($value)
      {
        $selectCriteria->add(CollectionCategoryPeer::ID, $value, $comparison);
      }
      else
      {
        $selectCriteria->setPrimaryTableName(CollectionCategoryPeer::TABLE_NAME);
      }

    } else { // $values is CollectionCategory object
  ...
  public static function doDeleteAll(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      CollectionCategoryPeer::clearInstancePool();
      CollectionCategoryPeer::clearRelatedInstancePool();
      $con->commit();
      return $affectedRows;
    }
    catch (PropelException $e)
   ...
   */
   public static function doDelete($values, PropelPDO $con = null)
   {
    ...
    } elseif ($values instanceof CollectionCategory) { // it's a model object
      // create criteria based on pk values
      $criteria = $values->buildPkeyCriteria();
    } else { // it's a primary key, or an array of pks
      $criteria = new Criteria(self::DATABASE_NAME);
      $criteria->add(CollectionCategoryPeer::ID, (array) $values, Criteria::IN);
    }
    ...
    try
    {
      ...
      if ($values instanceof Criteria)
      {
        ...
        CollectionCategoryPeer::removeInstanceFromPool($values);
      } else { // it's a primary key, or an array of pks
        foreach ((array) $values as $singleval)
        {
          CollectionCategoryPeer::removeInstanceFromPool($singleval);
        }
      }
  ...
  protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
  {
    ...
    foreach ($objects as $obj)
    {
      ...
      $selectCriteria = new Criteria(CollectionCategoryPeer::DATABASE_NAME);
      $updateValues = new Criteria(CollectionCategoryPeer::DATABASE_NAME);
      $selectCriteria->add(CollectorInterviewPeer::COLLECTION_CATEGORY_ID, $obj->getId());
      $updateValues->add(CollectorInterviewPeer::COLLECTION_CATEGORY_ID, null);

      BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

      // set fkey col in related Collection rows to NULL
      $selectCriteria = new Criteria(CollectionCategoryPeer::DATABASE_NAME);
      $updateValues = new Criteria(CollectionCategoryPeer::DATABASE_NAME);
      $selectCriteria->add(CollectionPeer::COLLECTION_CATEGORY_ID, $obj->getId());
      $updateValues->add(CollectionPeer::COLLECTION_CATEGORY_ID, null);
  ...
  /**
   * Validates all modified columns of given CollectionCategory object.
   * If parameter $columns is either a single column name or an array of column names
   * than only those columns are validated.
   *
   * NOTICE: This does not apply to primary or foreign keys for now.
   *
   * @param      CollectionCategory $obj The object to validate.
  ...
  public static function doValidate($obj, $cols = null)
  {
    ...
    if ($cols)
    {
      $dbMap = Propel::getDatabaseMap(CollectionCategoryPeer::DATABASE_NAME);
      $tableMap = $dbMap->getTable(CollectionCategoryPeer::TABLE_NAME);
    ...
    return BasePeer::doValidate(CollectionCategoryPeer::DATABASE_NAME, CollectionCategoryPeer::TABLE_NAME, $columns);
  }
  ...
  public static function retrieveByPK($pk, PropelPDO $con = null)
  {
    ...
    if (null !== ($obj = CollectionCategoryPeer::getInstanceFromPool((string) $pk)))
    {
      return $obj;
    }
    ...
    $criteria->add(CollectionCategoryPeer::ID, $pk);

    $v = CollectionCategoryPeer::doSelect($criteria, $con);
  ...
  public static function retrieveByPKs($pks, PropelPDO $con = null)
  {
    ...
    {
      $criteria = new Criteria(CollectionCategoryPeer::DATABASE_NAME);
      $criteria->add(CollectionCategoryPeer::ID, $pks, Criteria::IN);
      $objs = CollectionCategoryPeer::doSelect($criteria, $con);
    }
    return $objs;
  }
  ...
  static private function getMixerPreSelectHook($method)
  {
    ...
    {
      return sprintf('BaseCollectionCategoryPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
    }
...
//
BaseCollectionCategoryPeer::buildTableMap();
