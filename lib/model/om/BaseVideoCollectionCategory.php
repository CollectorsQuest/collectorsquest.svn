...
abstract class BaseVideoCollectionCategory extends BaseObject  implements Persistent
{
  ...
  protected function doInsert(PropelPDO $con)
  {
    ...
    if ($this->isColumnModified(VideoCollectionCategoryPeer::ID))
    {
      $modifiedColumns[':p' . $index++]  = '`ID`';
    }
    if ($this->isColumnModified(VideoCollectionCategoryPeer::VIDEO_ID))
    {
      $modifiedColumns[':p' . $index++]  = '`VIDEO_ID`';
    }
    if ($this->isColumnModified(VideoCollectionCategoryPeer::COLLECTION_CATEGORY_ID))
    {
    ...
    $sql = sprintf(
      'INSERT INTO `video_collection_category` (%s) VALUES (%s)',
