...
abstract class BaseCollectorFriend extends BaseObject  implements Persistent
{
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      return $startcol + 4; // 4 = CollectorFriendPeer::NUM_COLUMNS - CollectorFriendPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if (!$this->alreadyInSave)
    {
      ...
      if ($this->isModified())
      {
        if ($this->isNew())
        {
          ...
          if ($criteria->keyContainsValue(CollectorFriendPeer::ID) )
          {
        ...
        {
          $affectedRows += CollectorFriendPeer::doUpdate($this, $con);
        }
