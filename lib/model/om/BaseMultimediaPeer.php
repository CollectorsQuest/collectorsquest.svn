...
abstract class BaseMultimediaPeer
{
  ...
  const COLORS = 'multimedia.COLORS';

  /** the column name for the ORIENTATION field */
  const ORIENTATION = 'multimedia.ORIENTATION';
  ...
  public static function addSelectColumns(Criteria $criteria, $alias = null)
  {
    if (null === $alias)
    {
      ...
      $criteria->addSelectColumn(MultimediaPeer::MODEL);
      $criteria->addSelectColumn(MultimediaPeer::MODEL_ID);
      $criteria->addSelectColumn(MultimediaPeer::TYPE);
      $criteria->addSelectColumn(MultimediaPeer::NAME);
      $criteria->addSelectColumn(MultimediaPeer::MD5);
      $criteria->addSelectColumn(MultimediaPeer::COLORS);
   ...
   * @throws     PropelException Any exceptions caught during processing will be
   *     rethrown wrapped into a PropelException.
   * @return     array (Multimedia object, last column rank)
   */
  public static function populateObject($row, $startcol = 0)
  {
    $key = MultimediaPeer::getPrimaryKeyHashFromRow($row, $startcol);
    if (null !== ($obj = MultimediaPeer::getInstanceFromPool($key)))
    {
      // We no longer rehydrate the object, since this can cause data loss.
      // See http://www.propelorm.org/ticket/509
  ...
  public static function doInsert($values, PropelPDO $con = null)
  {
    ...
    if ($criteria->containsKey(MultimediaPeer::ID) && $criteria->keyContainsValue(MultimediaPeer::ID) )
    {
  ...
  public static function doUpdate($values, PropelPDO $con = null)
  {
    ...
    if ($values instanceof Criteria)
    {
      ...
      $value = $criteria->remove(MultimediaPeer::ID);
      if ($value)
      {
        $selectCriteria->add(MultimediaPeer::ID, $value, $comparison);
      }
      else
      {
        $selectCriteria->setPrimaryTableName(MultimediaPeer::TABLE_NAME);
      }
  ...
  public static function doDeleteAll($con = null)
  {
    ...
    try
    {
      ...
      $con->beginTransaction();
      $affectedRows += BasePeer::doDeleteAll(MultimediaPeer::TABLE_NAME, $con, MultimediaPeer::DATABASE_NAME);
  ...
  {
    return array(array('model', 'model_id', 'md5'));
  }
