...
/**
 * Base class that represents a row from the 'collection_category_field' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseCollectionCategoryField extends BaseObject  implements Persistent
{

  /**
   * Peer class name
   */
  const PEER = 'CollectionCategoryFieldPeer';

  /**
   * The Peer class.
   * Instance provides a convenient way of calling static methods on a class
   * that calling code may not be able to identify.
   * @var        CollectionCategoryFieldPeer
   */
  ...
  /**
   * The value for the custom_field_id field.
   * @var        int
   */
  ...
  /**
   * Get the [custom_field_id] column value.
   * 
   * @return     int
   */
   ...
   * @return     CollectionCategoryField The current object (for fluent API support)
   */
  public function setId($v)
  {
    ...
    {
      $this->id = $v;
      $this->modifiedColumns[] = CollectionCategoryFieldPeer::ID;
    }
  ...
  public function setCollectionCategoryId($v)
  {
    ...
    if ($this->collection_category_id !== $v)
    {
      ...
      $this->modifiedColumns[] = CollectionCategoryFieldPeer::COLLECTION_CATEGORY_ID;
    }
  ...
  /**
   * Set the value of [custom_field_id] column.
   * 
   * @param      int $v new value
   * @return     CollectionCategoryField The current object (for fluent API support)
   */
  public function setCustomFieldId($v)
  {
    if ($v !== null)
    {
      $v = (int) $v;
    ...
    if ($this->custom_field_id !== $v)
    {
      $this->custom_field_id = $v;
      $this->modifiedColumns[] = CollectionCategoryFieldPeer::CUSTOM_FIELD_ID;
    }

    if ($this->aCustomField !== null && $this->aCustomField->getId() !== $v)
    {
      $this->aCustomField = null;
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      $this->custom_field_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
      $this->resetModified();
    ...
    {
      throw new PropelException("Error populating CollectionCategoryField object", $e);
    }
  }
  ...
  public function ensureConsistency()
  {
    ...
    if ($this->aCustomField !== null && $this->custom_field_id !== $this->aCustomField->getId())
    {
      $this->aCustomField = null;
    }
  }
  ...
  public function reload($deep = false, PropelPDO $con = null)
  {
    ...
    $stmt = CollectionCategoryFieldPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
  ...
  public function save(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      // symfony_behaviors behavior
      foreach (sfMixer::getCallables('BaseCollectionCategoryField:save:pre') as $callable)
      {
      ...
      if ($ret)
      {
        ...
        $this->postSave($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BaseCollectionCategoryField:save:post') as $callable)
        {
          call_user_func($callable, $this, $con, $affectedRows);
        }

        CollectionCategoryFieldPeer::addInstanceToPool($this);
      }
      else
      {
        $affectedRows = 0;
  ...
  protected function doSave(PropelPDO $con)
  {
    ...
    if (!$this->alreadyInSave)
    {
      ...
      if ($this->aCustomField !== null)
      {
        if ($this->aCustomField->isModified() || $this->aCustomField->isNew())
        {
          $affectedRows += $this->aCustomField->save($con);
        }
        $this->setCustomField($this->aCustomField);
      }
  ...
  protected function doInsert(PropelPDO $con)
  {
    ...
    if ($this->isColumnModified(CollectionCategoryFieldPeer::ID))
    {
      $modifiedColumns[':p' . $index++]  = '`ID`';
    }
    if ($this->isColumnModified(CollectionCategoryFieldPeer::COLLECTION_CATEGORY_ID))
    {
      $modifiedColumns[':p' . $index++]  = '`COLLECTION_CATEGORY_ID`';
    }
    if ($this->isColumnModified(CollectionCategoryFieldPeer::CUSTOM_FIELD_ID))
    {
      $modifiedColumns[':p' . $index++]  = '`CUSTOM_FIELD_ID`';
    }

    $sql = sprintf(
      'INSERT INTO `collection_category_field` (%s) VALUES (%s)',
      ...
      foreach ($modifiedColumns as $identifier => $columnName)
      {
        switch ($columnName)
        {
          ...
          case '`CUSTOM_FIELD_ID`':
            $stmt->bindValue($identifier, $this->custom_field_id, PDO::PARAM_INT);
            break;
        }
      }
      $stmt->execute();
  ...
  protected function doValidate($columns = null)
  {
    if (!$this->alreadyInValidation)
    {
      ...
      if ($this->aCustomField !== null)
      {
        if (!$this->aCustomField->validate($columns))
        {
          $failureMap = array_merge($failureMap, $this->aCustomField->getValidationFailures());
        }
      }


      if (($retval = CollectionCategoryFieldPeer::doValidate($this, $columns)) !== true)
      {
  ...
  {
    $pos = CollectionCategoryFieldPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
  ...
  public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
  {
    ...
    if (array_key_exists($keys[2], $arr)) $this->setCustomFieldId($arr[$keys[2]]);
  }
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(CollectionCategoryFieldPeer::ID)) $criteria->add(CollectionCategoryFieldPeer::ID, $this->id);
    if ($this->isColumnModified(CollectionCategoryFieldPeer::COLLECTION_CATEGORY_ID)) $criteria->add(CollectionCategoryFieldPeer::COLLECTION_CATEGORY_ID, $this->collection_category_id);
    if ($this->isColumnModified(CollectionCategoryFieldPeer::CUSTOM_FIELD_ID)) $criteria->add(CollectionCategoryFieldPeer::CUSTOM_FIELD_ID, $this->custom_field_id);
  ...
  {
    $criteria = new Criteria(CollectionCategoryFieldPeer::DATABASE_NAME);
    $criteria->add(CollectionCategoryFieldPeer::ID, $this->id);
   ...
   *
   * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
   * @return     CollectionCategoryField Clone of current object.
   * @throws     PropelException
   */
   ...
   *
   * @return     CollectionCategoryFieldPeer
   */
  public function getPeer()
  {
    if (self::$peer === null)
    {
      self::$peer = new CollectionCategoryFieldPeer();
    }
    return self::$peer;
  }
  ...
  public function setCollectionCategory(CollectionCategory $v = null)
  {
    ...
    if ($v !== null)
    {
      $v->addCollectionCategoryField($this);
    }
  ...
  /**
   * Declares an association between this object and a CustomField object.
   *
   * @param      CustomField $v
   * @return     CollectionCategoryField The current object (for fluent API support)
   * @throws     PropelException
   */
  public function setCustomField(CustomField $v = null)
  {
    if ($v === null)
    {
      $this->setCustomFieldId(NULL);
    }
    else
    {
      $this->setCustomFieldId($v->getId());
    }

    $this->aCustomField = $v;

    // Add binding for other direction of this n:n relationship.
    // If this object has already been added to the CustomField object, it will not be re-added.
    if ($v !== null)
    {
      $v->addCollectionCategoryField($this);
    }
  ...
  /**
   * Get the associated CustomField object
   *
   * @param      PropelPDO Optional Connection object.
   * @return     CustomField The associated CustomField object.
   * @throws     PropelException
   */
  public function getCustomField(PropelPDO $con = null)
  {
    if ($this->aCustomField === null && ($this->custom_field_id !== null))
    {
