...
abstract class BaseFeaturedQuery extends ModelCriteria
{
   ...
   * 
   * @param     int|array $featuredTypeId The value to use as filter.
   *            Accepts an associative array('min' => $minValue, 'max' => $maxValue)
   * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
   *
   * @return    FeaturedQuery The current query, for fluid interface
   ...
   * 
   * @param     int|array $featuredId The value to use as filter.
   *            Accepts an associative array('min' => $minValue, 'max' => $maxValue)
   * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
   *
   * @return    FeaturedQuery The current query, for fluid interface
   ...
   * 
   * @param     int|array $treeScope The value to use as filter.
   *            Accepts an associative array('min' => $minValue, 'max' => $maxValue)
   * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
   *
   * @return    FeaturedQuery The current query, for fluid interface
