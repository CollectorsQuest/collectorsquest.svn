...
/**
 * Base class that represents a row from the 'term_relationship' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseTermRelationship extends BaseObject  implements Persistent
{

  /**
   * Peer class name
   */
  const PEER = 'TermRelationshipPeer';

  /**
   * The Peer class.
   * Instance provides a convenient way of calling static methods on a class
   * that calling code may not be able to identify.
   * @var        TermRelationshipPeer
   */
   ...
   * @return     TermRelationship The current object (for fluent API support)
   */
  public function setId($v)
  {
    ...
    {
      $this->id = $v;
      $this->modifiedColumns[] = TermRelationshipPeer::ID;
    }
  ...
  public function setTermId($v)
  {
    ...
    {
      $this->term_id = $v;
      $this->modifiedColumns[] = TermRelationshipPeer::TERM_ID;
    }
  ...
  public function setModel($v)
  {
    ...
    {
      $this->model = $v;
      $this->modifiedColumns[] = TermRelationshipPeer::MODEL;
    }
  ...
  public function setModelId($v)
  {
    ...
    {
      $this->model_id = $v;
      $this->modifiedColumns[] = TermRelationshipPeer::MODEL_ID;
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      $this->model_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
      $this->resetModified();
    ...
    {
      throw new PropelException("Error populating TermRelationship object", $e);
    }
  }
  ...
  public function reload($deep = false, PropelPDO $con = null)
  {
    ...
    $stmt = TermRelationshipPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
  ...
  public function save(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      // symfony_behaviors behavior
      foreach (sfMixer::getCallables('BaseTermRelationship:save:pre') as $callable)
      {
      ...
      if ($ret)
      {
        ...
        $this->postSave($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BaseTermRelationship:save:post') as $callable)
        {
          call_user_func($callable, $this, $con, $affectedRows);
        }

        TermRelationshipPeer::addInstanceToPool($this);
      }
      else
      {
        $affectedRows = 0;
  ...
  protected function doInsert(PropelPDO $con)
  {
    ...
    if ($this->isColumnModified(TermRelationshipPeer::ID))
    {
      $modifiedColumns[':p' . $index++]  = '`ID`';
    }
    if ($this->isColumnModified(TermRelationshipPeer::TERM_ID))
    {
      $modifiedColumns[':p' . $index++]  = '`TERM_ID`';
    }
    if ($this->isColumnModified(TermRelationshipPeer::MODEL))
    {
      $modifiedColumns[':p' . $index++]  = '`MODEL`';
    }
    if ($this->isColumnModified(TermRelationshipPeer::MODEL_ID))
    {
      $modifiedColumns[':p' . $index++]  = '`MODEL_ID`';
    }

    $sql = sprintf(
      'INSERT INTO `term_relationship` (%s) VALUES (%s)',
  ...
  protected function doValidate($columns = null)
  {
    if (!$this->alreadyInValidation)
    {
      ...
      if (($retval = TermRelationshipPeer::doValidate($this, $columns)) !== true)
      {
  ...
  {
    $pos = TermRelationshipPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
  ...
  public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
  {
    ...
    if (array_key_exists($keys[3], $arr)) $this->setModelId($arr[$keys[3]]);
  }
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(TermRelationshipPeer::ID)) $criteria->add(TermRelationshipPeer::ID, $this->id);
    if ($this->isColumnModified(TermRelationshipPeer::TERM_ID)) $criteria->add(TermRelationshipPeer::TERM_ID, $this->term_id);
    if ($this->isColumnModified(TermRelationshipPeer::MODEL)) $criteria->add(TermRelationshipPeer::MODEL, $this->model);
    if ($this->isColumnModified(TermRelationshipPeer::MODEL_ID)) $criteria->add(TermRelationshipPeer::MODEL_ID, $this->model_id);
  ...
  {
    $criteria = new Criteria(TermRelationshipPeer::DATABASE_NAME);
    $criteria->add(TermRelationshipPeer::ID, $this->id);
   ...
   *
   * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
   * @return     TermRelationship Clone of current object.
   * @throws     PropelException
   */
   ...
   *
   * @return     TermRelationshipPeer
   */
  public function getPeer()
  {
    if (self::$peer === null)
    {
      self::$peer = new TermRelationshipPeer();
    }
    return self::$peer;
  }
