...
/**
 * Base class that represents a row from the 'collector_email' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseCollectorEmail extends BaseObject  implements Persistent
{

  /**
   * Peer class name
   */
  const PEER = 'CollectorEmailPeer';

  /**
   * The Peer class.
   * Instance provides a convenient way of calling static methods on a class
   * that calling code may not be able to identify.
   * @var        CollectorEmailPeer
   */
  ...
  /**
   * Initializes internal state of BaseCollectorEmail object.
   * @see        applyDefaults()
   */
  ...
  public function setCollectorId($v)
  {
    ...
    {
      $this->collector_id = $v;
      $this->modifiedColumns[] = CollectorEmailPeer::COLLECTOR_ID;
    }
  ...
  public function setEmail($v)
  {
    ...
    {
      $this->email = $v;
      $this->modifiedColumns[] = CollectorEmailPeer::EMAIL;
    }
  ...
  public function setHash($v)
  {
    ...
    {
      $this->hash = $v;
      $this->modifiedColumns[] = CollectorEmailPeer::HASH;
    }
  ...
  public function setSalt($v)
  {
    ...
    {
      $this->salt = $v;
      $this->modifiedColumns[] = CollectorEmailPeer::SALT;
    }
  ...
  public function setIsVerified($v)
  {
    ...
    {
      $this->is_verified = $v;
      $this->modifiedColumns[] = CollectorEmailPeer::IS_VERIFIED;
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      return $startcol + 8; // 8 = CollectorEmailPeer::NUM_HYDRATE_COLUMNS.

    }
    catch (Exception $e)
    {
      throw new PropelException("Error populating CollectorEmail object", $e);
    }
  }
  ...
  public function reload($deep = false, PropelPDO $con = null)
  {
    ...
    $stmt = CollectorEmailPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
  ...
  public function delete(PropelPDO $con = null)
  {
    ...
    try
    {
      $deleteQuery = CollectorEmailQuery::create()
        ->filterByPrimaryKey($this->getPrimaryKey());
      $ret = $this->preDelete($con);
      // symfony_behaviors behavior
      foreach (sfMixer::getCallables('BaseCollectorEmail:delete:pre') as $callable)
      {
      ...
      if ($ret)
      {
        ...
        $this->postDelete($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BaseCollectorEmail:delete:post') as $callable)
        {
  ...
  public function save(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      // symfony_behaviors behavior
      foreach (sfMixer::getCallables('BaseCollectorEmail:save:pre') as $callable)
      {
      ...
      if ($ret)
      {
        ...
        $this->postSave($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BaseCollectorEmail:save:post') as $callable)
        {
          call_user_func($callable, $this, $con, $affectedRows);
        }

        CollectorEmailPeer::addInstanceToPool($this);
      }
      else
      {
        $affectedRows = 0;
  ...
  protected function doValidate($columns = null)
  {
    if (!$this->alreadyInValidation)
    {
      ...
      if (($retval = CollectorEmailPeer::doValidate($this, $columns)) !== true)
      {
  ...
  {
    $pos = CollectorEmailPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
  ...
  {
    if (isset($alreadyDumpedObjects['CollectorEmail'][$this->getPrimaryKey()]))
    {
      return '*RECURSION*';
    }
    $alreadyDumpedObjects['CollectorEmail'][$this->getPrimaryKey()] = true;
    $keys = CollectorEmailPeer::getFieldNames($keyType);
    $result = array(
      $keys[0] => $this->getId(),
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(CollectorEmailPeer::ID)) $criteria->add(CollectorEmailPeer::ID, $this->id);
    if ($this->isColumnModified(CollectorEmailPeer::COLLECTOR_ID)) $criteria->add(CollectorEmailPeer::COLLECTOR_ID, $this->collector_id);
    if ($this->isColumnModified(CollectorEmailPeer::EMAIL)) $criteria->add(CollectorEmailPeer::EMAIL, $this->email);
  ...
  {
    $criteria = new Criteria(CollectorEmailPeer::DATABASE_NAME);
    $criteria->add(CollectorEmailPeer::ID, $this->id);
   ...
   * objects.
   *
   * @param      object $copyObj An object of CollectorEmail (or compatible) type.
   ...
   *
   * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
   * @return     CollectorEmail Clone of current object.
   * @throws     PropelException
   */
   ...
   *
   * @return     CollectorEmailPeer
   */
  public function getPeer()
  {
    if (self::$peer === null)
    {
      self::$peer = new CollectorEmailPeer();
    }
    return self::$peer;
  }
  ...
  public function getCollector(PropelPDO $con = null)
  {
    if ($this->aCollector === null && ($this->collector_id !== null))
    {
      ...
      /* The following can be used additionally to
        ...
        $this->aCollector->addCollectorEmails($this);
       */
    }
  ...
  public function __call($name, $params)
  {
    ...
    // symfony_behaviors behavior
    if ($callable = sfMixer::getCallable('BaseCollectorEmail:' . $name))
    {
