...
abstract class BaseEventPeer
{
  ...
  private static $fieldNames = array (
    BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Description', 'CreatedAt', ),
    BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'description', 'createdAt', ),
    BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::DESCRIPTION, self::CREATED_AT, ),
    BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'DESCRIPTION', 'CREATED_AT', ),
    BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'description', 'created_at', ),
  ...
  private static $fieldKeys = array (
    BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Description' => 2, 'CreatedAt' => 3, ),
    BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'createdAt' => 3, ),
    BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::DESCRIPTION => 2, self::CREATED_AT => 3, ),
    BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'DESCRIPTION' => 2, 'CREATED_AT' => 3, ),
    BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'created_at' => 3, ),
    BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
  );
