...
abstract class BaseVideoQuery extends ModelCriteria
{
  ...
  {
    $sql = 'SELECT `ID`, `TITLE`, `SLUG`, `DESCRIPTION`, `TYPE`, `LENGTH`, `FILENAME`, `THUMB_SMALL`, `THUMB_LARGE`, `IS_PUBLISHED`, `PUBLISHED_AT`, `UPLOADED_AT`, `CREATED_AT` FROM `video` WHERE `ID` = :p0';
    try
    {
