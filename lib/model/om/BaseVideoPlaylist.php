...
/**
 * Base class that represents a row from the 'video_playlist' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseVideoPlaylist extends BaseObject  implements Persistent
{

  /**
   * Peer class name
   */
  const PEER = 'VideoPlaylistPeer';

  /**
   * The Peer class.
   * Instance provides a convenient way of calling static methods on a class
   * that calling code may not be able to identify.
   * @var        VideoPlaylistPeer
   */
   ...
   * @return     VideoPlaylist The current object (for fluent API support)
   */
  public function setId($v)
  {
    ...
    {
      $this->id = $v;
      $this->modifiedColumns[] = VideoPlaylistPeer::ID;
    }
  ...
  public function setVideoId($v)
  {
    ...
    {
      $this->video_id = $v;
      $this->modifiedColumns[] = VideoPlaylistPeer::VIDEO_ID;
    }
  ...
  public function setPlaylistId($v)
  {
    ...
    {
      $this->playlist_id = $v;
      $this->modifiedColumns[] = VideoPlaylistPeer::PLAYLIST_ID;
    }
  ...
  public function setPosition($v)
  {
    ...
    {
      $this->position = $v;
      $this->modifiedColumns[] = VideoPlaylistPeer::POSITION;
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      $this->playlist_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
    ...
    {
      throw new PropelException("Error populating VideoPlaylist object", $e);
    }
  }
  ...
  public function reload($deep = false, PropelPDO $con = null)
  {
    ...
    $stmt = VideoPlaylistPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
  ...
  public function save(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      // symfony_behaviors behavior
      foreach (sfMixer::getCallables('BaseVideoPlaylist:save:pre') as $callable)
      {
      ...
      if ($ret)
      {
        ...
        $this->postSave($con);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables('BaseVideoPlaylist:save:post') as $callable)
        {
          call_user_func($callable, $this, $con, $affectedRows);
        }

        VideoPlaylistPeer::addInstanceToPool($this);
      }
      else
      {
        $affectedRows = 0;
  ...
  protected function doInsert(PropelPDO $con)
  {
    ...
    if ($this->isColumnModified(VideoPlaylistPeer::ID))
    {
      $modifiedColumns[':p' . $index++]  = '`ID`';
    }
    if ($this->isColumnModified(VideoPlaylistPeer::VIDEO_ID))
    {
      $modifiedColumns[':p' . $index++]  = '`VIDEO_ID`';
    }
    if ($this->isColumnModified(VideoPlaylistPeer::PLAYLIST_ID))
    {
      $modifiedColumns[':p' . $index++]  = '`PLAYLIST_ID`';
    }
    if ($this->isColumnModified(VideoPlaylistPeer::POSITION))
    {
      $modifiedColumns[':p' . $index++]  = '`POSITION`';
    }

    $sql = sprintf(
      'INSERT INTO `video_playlist` (%s) VALUES (%s)',
  ...
  protected function doValidate($columns = null)
  {
    if (!$this->alreadyInValidation)
    {
      ...
      if (($retval = VideoPlaylistPeer::doValidate($this, $columns)) !== true)
      {
  ...
  {
    $pos = VideoPlaylistPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
  ...
  public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
  {
    ...
    if (array_key_exists($keys[2], $arr)) $this->setPlaylistId($arr[$keys[2]]);
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(VideoPlaylistPeer::ID)) $criteria->add(VideoPlaylistPeer::ID, $this->id);
    if ($this->isColumnModified(VideoPlaylistPeer::VIDEO_ID)) $criteria->add(VideoPlaylistPeer::VIDEO_ID, $this->video_id);
    if ($this->isColumnModified(VideoPlaylistPeer::PLAYLIST_ID)) $criteria->add(VideoPlaylistPeer::PLAYLIST_ID, $this->playlist_id);
    if ($this->isColumnModified(VideoPlaylistPeer::POSITION)) $criteria->add(VideoPlaylistPeer::POSITION, $this->position);
  ...
  {
    $criteria = new Criteria(VideoPlaylistPeer::DATABASE_NAME);
    $criteria->add(VideoPlaylistPeer::ID, $this->id);
   ...
   *
   * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
   * @return     VideoPlaylist Clone of current object.
   * @throws     PropelException
   */
   ...
   *
   * @return     VideoPlaylistPeer
   */
  public function getPeer()
  {
    if (self::$peer === null)
    {
      self::$peer = new VideoPlaylistPeer();
    }
    return self::$peer;
  }
