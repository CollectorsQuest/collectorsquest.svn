...
abstract class BaseCollectibleOffer extends BaseObject  implements Persistent
{
  ...
  public function setDeletedAt($v)
  {
    ...
    if ( $this->deleted_at !== null || $dt !== null )
    {
          ...
          )
      {
        ...
        $this->modifiedColumns[] = CollectibleOfferPeer::DELETED_AT;
      }
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      return $startcol + 9; // 9 = CollectibleOfferPeer::NUM_COLUMNS - CollectibleOfferPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function delete(PropelPDO $con = null)
  {
    ...
    try
    {
      ...
      if (!empty($ret) && CollectibleOfferQuery::isSoftDeleteEnabled())
      {
        $this->setDeletedAt(time());
        $this->save($con);
        $con->commit();
        CollectibleOfferPeer::removeInstanceFromPool($this);
        return;
      }
    ...
    if (!$this->alreadyInSave)
    {
      ...
      if ($this->isModified())
      {
        if ($this->isNew())
        {
          ...
          if ($criteria->keyContainsValue(CollectibleOfferPeer::ID) )
          {
        ...
        {
          $affectedRows += CollectibleOfferPeer::doUpdate($this, $con);
        }
  ...
  public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
  {
    ...
    if ($includeForeignObjects)
    {
      ...
      {
        $result['CollectibleForSale'] = $this->aCollectibleForSale->toArray($keyType, $includeLazyLoadColumns, true);
      }
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(CollectibleOfferPeer::DELETED_AT)) $criteria->add(CollectibleOfferPeer::DELETED_AT, $this->deleted_at);
  ...
  public function copyInto($copyObj, $deepCopy = false)
  {
    ...
    $copyObj->setCollectibleForSaleId($this->collectible_for_sale_id);
  ...
  {
    CollectibleOfferPeer::disableSoftDelete();
    $this->delete($con);
  }
