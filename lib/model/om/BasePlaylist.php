...
abstract class BasePlaylist extends BaseObject  implements Persistent
{
  ...
  public function setSlug($v)
  {
    ...
    {
      $this->slug = $v;
      $this->modifiedColumns[] = PlaylistPeer::SLUG;
    }
  ...
  public function setIsPublished($v)
  {
    ...
    {
      $this->is_published = $v;
      $this->modifiedColumns[] = PlaylistPeer::IS_PUBLISHED;
    }
  ...
  public function setPublishedAt($v)
  {
    ...
    if ( $this->published_at !== null || $dt !== null )
    {
          ...
          )
      {
        ...
        $this->modifiedColumns[] = PlaylistPeer::PUBLISHED_AT;
      }
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      return $startcol + 9; // 9 = PlaylistPeer::NUM_COLUMNS - PlaylistPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(PlaylistPeer::SLUG)) $criteria->add(PlaylistPeer::SLUG, $this->slug);
    ...
    if ($this->isColumnModified(PlaylistPeer::IS_PUBLISHED)) $criteria->add(PlaylistPeer::IS_PUBLISHED, $this->is_published);
    if ($this->isColumnModified(PlaylistPeer::PUBLISHED_AT)) $criteria->add(PlaylistPeer::PUBLISHED_AT, $this->published_at);
   ...
   * @return     PropelCollection|array VideoPlaylist[] List of VideoPlaylist objects
   */
  public function getVideoPlaylistsJoinVideo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
  {
    $query = VideoPlaylistQuery::create(null, $criteria);
  ...
  {
    // symfony_behaviors behavior
    if ($callable = sfMixer::getCallable('BasePlaylist:' . $name))
    {
