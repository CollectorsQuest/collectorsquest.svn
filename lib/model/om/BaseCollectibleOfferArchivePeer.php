...
abstract class BaseCollectibleOfferArchivePeer
{
  ...
  const CLASS_DEFAULT = 'lib.model.CollectibleOfferArchive';
  ...
  protected static $fieldNames = array (
    BasePeer::TYPE_PHPNAME => array ('Id', 'CollectibleId', 'CollectibleForSaleId', 'CollectorId', 'Price', 'Status', 'ArchivedAt', ),
    BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'collectibleId', 'collectibleForSaleId', 'collectorId', 'price', 'status', 'archivedAt', ),
    BasePeer::TYPE_COLNAME => array (self::ID, self::COLLECTIBLE_ID, self::COLLECTIBLE_FOR_SALE_ID, self::COLLECTOR_ID, self::PRICE, self::STATUS, self::ARCHIVED_AT, ),
    BasePeer::TYPE_RAW_COLNAME => array ('ID', 'COLLECTIBLE_ID', 'COLLECTIBLE_FOR_SALE_ID', 'COLLECTOR_ID', 'PRICE', 'STATUS', 'ARCHIVED_AT', ),
    BasePeer::TYPE_FIELDNAME => array ('id', 'collectible_id', 'collectible_for_sale_id', 'collector_id', 'price', 'status', 'archived_at', ),
  ...
  protected static $fieldKeys = array (
    BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CollectibleId' => 1, 'CollectibleForSaleId' => 2, 'CollectorId' => 3, 'Price' => 4, 'Status' => 5, 'ArchivedAt' => 6, ),
    BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'collectibleId' => 1, 'collectibleForSaleId' => 2, 'collectorId' => 3, 'price' => 4, 'status' => 5, 'archivedAt' => 6, ),
    BasePeer::TYPE_COLNAME => array (self::ID => 0, self::COLLECTIBLE_ID => 1, self::COLLECTIBLE_FOR_SALE_ID => 2, self::COLLECTOR_ID => 3, self::PRICE => 4, self::STATUS => 5, self::ARCHIVED_AT => 6, ),
    BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'COLLECTIBLE_ID' => 1, 'COLLECTIBLE_FOR_SALE_ID' => 2, 'COLLECTOR_ID' => 3, 'PRICE' => 4, 'STATUS' => 5, 'ARCHIVED_AT' => 6, ),
    BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'collectible_id' => 1, 'collectible_for_sale_id' => 2, 'collector_id' => 3, 'price' => 4, 'status' => 5, 'archived_at' => 6, ),
    BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
  );
