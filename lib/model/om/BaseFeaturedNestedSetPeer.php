...
require 'lib/model/om/BaseFeaturedPeer.php';

/**
 * Base static class for performing query operations on the tree contained by the 'featured' table.
 *
 * 
 *
 ...
 */
abstract class BaseFeaturedNestedSetPeer extends BaseFeaturedPeer implements NodePeer {

	/**
	 * Left column for the set
	 */
	const LEFT_COL = 'featured.TREE_LEFT';

	/**
	 * Right column for the set
	 */
	const RIGHT_COL = 'featured.TREE_RIGHT';

	/**
	 * Scope column for the set
	 */
	const SCOPE_COL = 'featured.TREE_SCOPE';

	/**
	 * Creates the supplied node as the root node.
	 *
	 * @param      Featured $node	Propel object for model
	 ...
	 * @return     Featured			Propel object for root node
	 */
	public static function retrieveRoot($scopeId = null, PropelPDO $con = null)
	{
		$c = new Criteria(FeaturedPeer::DATABASE_NAME);
		...
		return FeaturedPeer::doSelectOne($c, $con);
	}

	/**
	 * Inserts $child as first child of given $parent node
	 *
	 * @param      Featured $child	Propel object for child node
	 * @param      Featured $parent	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      Featured $node		Propel object for destination node
	 * @param      Featured $sibling	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      Featured $parent	Propel object for given parent node
	 * @param      Featured $node	Propel object for given destination node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      Featured $node	Propel object as root node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	public static function insertRoot(NodeObject $node, PropelPDO $con = null)
	{
		...
		FeaturedPeer::insertAsParentOf(FeaturedPeer::retrieveRoot($sidv, $con), $node, $con);
	}
	 ...
	 * @param      Featured $child	Propel object to become child node
	 * @param      Featured $parent	Propel object as parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	...
	public static function deleteRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		$root = FeaturedPeer::retrieveRoot($scopeId, $con);
		if (FeaturedPeer::getNumberOfChildren($root) == 1) {
			return FeaturedPeer::deleteNode($root, $con);
		} else {
			return false;
		}
	}
	 ...
	 * Delete $dest node
	 *
	 * @param      Featured $dest	Propel object node to delete
	 * @param      PropelPDO $con	Connection to use.
	 * @return     boolean		Deletion status
	 */
	public static function deleteNode(NodeObject $dest, PropelPDO $con = null)
	{
		if ($dest->getLeftValue() == 1) {
			...
			return FeaturedPeer::deleteRoot($con);
		}
	 ...
	 *
	 * @param      Featured $dest	Propel object for destination node
	 * @param      Featured $node	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      Featured $node	Propel object for src node
	 * @param      PropelPDO $con	Connection to use.
	...
	public static function retrievePrevSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$prevSibling = FeaturedPeer::doSelectOne($c, $con);
	...
	public static function retrieveNextSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$nextSibling = FeaturedPeer::doSelectOne($c, $con);
	...
	public static function retrieveTree($scopeId = null, PropelPDO $con = null)
	{
		...
		$stmt = FeaturedPeer::doSelectStmt($c, $con);
		if (false !== ($row = $stmt->fetch(PDO::FETCH_NUM))) {
			$omClass = FeaturedPeer::getOMClass($row, 0);
			$cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);

			$key = FeaturedPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null === ($root = FeaturedPeer::getInstanceFromPool($key))) {
				$root = new $cls();
				$root->hydrate($row);
			}
	 ...
	 *
	 * @param      Featured $node	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 */
	public static function retrieveBranch(NodeObject $node, PropelPDO $con = null)
	{
		return FeaturedPeer::retrieveDescendants($node, $con);
	}
	...
	public static function retrieveChildren(NodeObject $node, PropelPDO $con = null)
	{
		...
		return FeaturedPeer::hydrateChildren($node, $stmt);
	}
	...
	public static function retrieveDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		return FeaturedPeer::hydrateDescendants($node, $stmt);
	}
	...
	{
		$parent = FeaturedPeer::retrieveParent($node, $con);
		$siblings = FeaturedPeer::retrieveChildren($parent, $con);
	...
	public static function retrieveParent(NodeObject $node, PropelPDO $con = null)
	{
		...
		$parent = FeaturedPeer::doSelectOne($c, $con);
	...
	{
		$children = FeaturedPeer::retrieveChildren($node);
	 ...
	 *
	 * @param      Featured $node	Propel object of node to create path to
	 * @param      PropelPDO $con	Connection to use.
	 ...
	 *
	 * @param      Featured $child	Propel object for node
	 * @param      Featured $parent	Propel object for node
	 * @return     bool
	 */
	 ...
	 * @param      Featured $node1		Propel object for node
	 * @param      Featured $node2		Propel object for node
	 * @return     bool
	 */
	 ...
	 *
	 * @param      Featured $node		Propel object for node
	 * @param      PropelPDO $con		Connection to use.
	 * @return     bool
	 */
	public static function hasParent(NodeObject $node, PropelPDO $con = null)
	{
		return FeaturedPeer::isValid(FeaturedPeer::retrieveParent($node, $con));
	}
	...
	{
		return FeaturedPeer::isValid(FeaturedPeer::retrievePrevSibling($node, $con));
	}
	...
	{
		return FeaturedPeer::isValid(FeaturedPeer::retrieveNextSibling($node, $con));
	}
	...
	public static function deleteDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		$result = FeaturedPeer::doDelete($c, $con);
	 ...
	 *
	 * @param      int/Featured $node	Primary key/instance of required node
	 * @param      PropelPDO $con		Connection to use.
	...
	public static function getNode($node, PropelPDO $con = null)
	{
		if (is_object($node)) {
			...
			$object = FeaturedPeer::retrieveByPK($node, $con);
	...
	protected static function hydrateDescendants(NodeObject $node, PDOStatement $stmt)
	{
		...
		$cls = FeaturedPeer::getOMClass();
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = FeaturedPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null === ($child = FeaturedPeer::getInstanceFromPool($key))) {
				$child = new $cls();
				$child->hydrate($row);
			}
			...
			if ($child->hasChildren()) {
				$descendants = array_merge($descendants, FeaturedPeer::hydrateDescendants($child, $stmt));
			} else {
			...
			FeaturedPeer::addInstanceToPool($child);
	...
	protected static function updateLoadedNode(NodeObject $node, $delta, PropelPDO $con = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			...
			if (!empty($keys)) {
				...
				$criteria->add(FeaturedPeer::ID, $keys, Criteria::IN);

				$stmt = FeaturedPeer::doSelectStmt($criteria, $con);
				while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
					$key = FeaturedPeer::getPrimaryKeyHashFromRow($row, 0);
					if (null !== ($object = FeaturedPeer::getInstanceFromPool($key))) {
	 ...
	 *
	 * @param      Featured $node Propel object for node to update
	...
	protected static function shiftRLValues($first, $delta, PropelPDO $con = null, $scopeId = null)
	{
		...
		$whereCriteria = new Criteria(FeaturedPeer::DATABASE_NAME);
		...
		$valuesCriteria = new Criteria(FeaturedPeer::DATABASE_NAME);
		$valuesCriteria->add(
			self::LEFT_COL,
