...
abstract class BaseScore extends BaseObject  implements Persistent
{
  ...
  /**
   * Initializes internal state of BaseScore object.
   * @see        applyDefaults()
   */
  ...
  public function setDay($v)
  {
    ...
    if ( $this->day !== null || $dt !== null )
    {
          ...
          )
      {
        ...
        $this->modifiedColumns[] = ScorePeer::DAY;
      }
    }
  ...
  public function setModel($v)
  {
    ...
    {
      $this->model = $v;
      $this->modifiedColumns[] = ScorePeer::MODEL;
    }
  ...
  public function setModelId($v)
  {
    ...
    {
      $this->model_id = $v;
      $this->modifiedColumns[] = ScorePeer::MODEL_ID;
    }
  ...
  public function setViews($v)
  {
    ...
    {
      $this->views = $v;
      $this->modifiedColumns[] = ScorePeer::VIEWS;
    }
  ...
  public function setRatings($v)
  {
    ...
    if ($this->ratings !== $v || $this->isNew())
    {
      $this->ratings = $v;
      $this->modifiedColumns[] = ScorePeer::RATINGS;
    }
  ...
  public function setScore($v)
  {
    ...
    {
      $this->score = $v;
      $this->modifiedColumns[] = ScorePeer::SCORE;
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      return $startcol + 9; // 9 = ScorePeer::NUM_COLUMNS - ScorePeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(ScorePeer::DAY)) $criteria->add(ScorePeer::DAY, $this->day);
    if ($this->isColumnModified(ScorePeer::MODEL)) $criteria->add(ScorePeer::MODEL, $this->model);
    if ($this->isColumnModified(ScorePeer::MODEL_ID)) $criteria->add(ScorePeer::MODEL_ID, $this->model_id);
  ...
  {
    // symfony_behaviors behavior
    if ($callable = sfMixer::getCallable('BaseScore:' . $name))
    {
