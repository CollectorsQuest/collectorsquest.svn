 ...
 * @method     CollectionItemQuery orderByCollectibleId($order = Criteria::ASC) Order by the collectible_id column
 ...
 * @method     CollectionItemQuery orderByScore($order = Criteria::ASC) Order by the score column
 ...
 * @method     CollectionItemQuery groupByCollectibleId() Group by the collectible_id column
 ...
 * @method     CollectionItemQuery groupByScore() Group by the score column
 ...
 *
 * @method     CollectionItemQuery leftJoinComment($relationAlias = '') Adds a LEFT JOIN clause to the query using the Comment relation
 * @method     CollectionItemQuery rightJoinComment($relationAlias = '') Adds a RIGHT JOIN clause to the query using the Comment relation
 * @method     CollectionItemQuery innerJoinComment($relationAlias = '') Adds a INNER JOIN clause to the query using the Comment relation
 *
 ...
 * @method     CollectionItem findOneByCollectibleId(int $collectible_id) Return the first CollectionItem filtered by the collectible_id column
 ...
 * @method     CollectionItem findOneByScore(int $score) Return the first CollectionItem filtered by the score column
 ...
 * @method     array findByCollectibleId(int $collectible_id) Return CollectionItem objects filtered by the collectible_id column
 ...
 * @method     array findByScore(int $score) Return CollectionItem objects filtered by the score column
...
abstract class BaseCollectionItemQuery extends ModelCriteria
{
	...
	public function filterByCollectibleId($collectibleId = null, $comparison = null)
	{
		if (is_array($collectibleId)) {
			...
			if (isset($collectibleId['min'])) {
				$this->addUsingAlias(CollectionItemPeer::COLLECTIBLE_ID, $collectibleId['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($collectibleId['max'])) {
				$this->addUsingAlias(CollectionItemPeer::COLLECTIBLE_ID, $collectibleId['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(CollectionItemPeer::COLLECTIBLE_ID, $collectibleId, $comparison);
	}
	...
	public function filterByScore($score = null, $comparison = null)
	{
		if (is_array($score)) {
			$useMinMax = false;
			if (isset($score['min'])) {
				$this->addUsingAlias(CollectionItemPeer::SCORE, $score['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($score['max'])) {
				$this->addUsingAlias(CollectionItemPeer::SCORE, $score['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(CollectionItemPeer::SCORE, $score, $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(CollectionItemPeer::ID, $comment->getItemId(), $comparison);
	}
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function joinComment($relationAlias = '', $joinType = Criteria::LEFT_JOIN)
	{
		$tableMap = $this->getTableMap();
	 ...
	 */
	public function useCommentQuery($relationAlias = '', $joinType = Criteria::LEFT_JOIN)
	{
		return $this
