...
abstract class BaseCollectorProfileQuery extends ModelCriteria
{
  ...
  public function findPk($key, $con = null)
  {
    ...
    if ((null !== ($obj = CollectorProfilePeer::getInstanceFromPool((string) $key))) && !$this->formatter)
    {
   ...
   *
   * @return    CollectorProfile A model object, or null if the key is not found
   */
  protected function findPkSimple($key, $con)
  {
    $sql = 'SELECT `ID`, `COLLECTOR_ID`, `COLLECTOR_TYPE`, `BIRTHDAY`, `GENDER`, `ZIP_POSTAL`, `COUNTRY`, `COUNTRY_ISO3166`, `WEBSITE`, `ABOUT`, `COLLECTIONS`, `COLLECTING`, `MOST_SPENT`, `ANUALLY_SPENT`, `NEW_ITEM_EVERY`, `INTERESTS`, `IS_FEATURED`, `IS_SELLER`, `IS_IMAGE_AUTO`, `PREFERENCES`, `NOTIFICATIONS`, `CREATED_AT`, `UPDATED_AT` FROM `collector_profile` WHERE `ID` = :p0';
    try
    {
    ...
    {
      $obj = new CollectorProfile();
      $obj->hydrate($row);
      CollectorProfilePeer::addInstanceToPool($obj, (string) $row[0]);
    }
    $stmt->closeCursor();
  ...
  {
    return $this->addUsingAlias(CollectorProfilePeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
  }
  ...
  {
    return $this->addUsingAlias(CollectorProfilePeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
  }
  ...
  {
    return $this->addDescendingOrderByColumn(CollectorProfilePeer::UPDATED_AT);
  }
  ...
  {
    return $this->addAscendingOrderByColumn(CollectorProfilePeer::UPDATED_AT);
  }
  ...
  {
    return $this->addDescendingOrderByColumn(CollectorProfilePeer::CREATED_AT);
  }
  ...
  {
    return $this->addAscendingOrderByColumn(CollectorProfilePeer::CREATED_AT);
  }
