...
abstract class BaseEventVideo extends BaseObject  implements Persistent
{
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      return $startcol + 10; // 10 = EventVideoPeer::NUM_COLUMNS - EventVideoPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if (!$this->alreadyInSave)
    {
      ...
      if ($this->isModified())
      {
        if ($this->isNew())
        {
          ...
          if ($criteria->keyContainsValue(EventVideoPeer::ID) )
          {
        ...
        {
          $affectedRows += EventVideoPeer::doUpdate($this, $con);
        }
