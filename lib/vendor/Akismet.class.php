...
class Akismet
{
   ...
   * Tests for spam.
   *
   * Uses the web service provided by {@link http://www.akismet.com Akismet} to see whether or not the submitted comment is spam.
   ...
   */
  public function setAkismetServer($akismetServer = 'rest.akismet.com')
  {
   ...
   */
  public function setAkismetVersion($akismetVersion = '1.1')
  {
...
class SocketWriteRead
{
  ...
  /**
   * Returns the error number. If there was no error, 0 will be returned.
   *
   * @return int
   */
