...
abstract class BaseCollectionItemOfferPeer {
	...
	const CLASS_DEFAULT = 'lib.legacy.CollectionItemOffer';
	 ...
	 */
	public static function addInstanceToPool(CollectionItemOffer $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = CollectionItemOfferPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + CollectionItemOfferPeer::NUM_COLUMNS;
		} else {
	...
	public static function doSelectJoinCollectionItem(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CollectionItemOfferPeer::addSelectColumns($criteria);
		$startcol = (CollectionItemOfferPeer::NUM_COLUMNS - CollectionItemOfferPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CollectionItemOfferPeer::addSelectColumns($criteria);
		$startcol2 = (CollectionItemOfferPeer::NUM_COLUMNS - CollectionItemOfferPeer::NUM_LAZY_LOAD_COLUMNS);

		CollectionItemPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (CollectionItemPeer::NUM_COLUMNS - CollectionItemPeer::NUM_LAZY_LOAD_COLUMNS);

		CollectionItemForSalePeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (CollectionItemForSalePeer::NUM_COLUMNS - CollectionItemForSalePeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAllExceptCollectionItem(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CollectionItemForSalePeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (CollectionItemForSalePeer::NUM_COLUMNS - CollectionItemForSalePeer::NUM_LAZY_LOAD_COLUMNS);
	...
	/**
	 * Method perform an INSERT on the database, given a CollectionItemOffer or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCollectionItemOfferPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCollectionItemOfferPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCollectionItemOfferPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCollectionItemOfferPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a CollectionItemOffer or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCollectionItemOfferPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCollectionItemOfferPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCollectionItemOfferPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCollectionItemOfferPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the collection_item_offer table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a CollectionItemOffer or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(CollectionItemOffer $obj, $cols = null)
	{
		$columns = array();
