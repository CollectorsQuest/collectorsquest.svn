...
abstract class BaseCollectionItemOfferQuery extends ModelCriteria
{
	 ...
	 * @return    CollectionItemOfferQuery The current query, for fluid interface
	 */
	public function filterByItemForSaleId($itemForSaleId = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemOfferQuery The current query, for fluid interface
	 */
	public function filterByCollectorId($collectorId = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemOfferQuery The current query, for fluid interface
	 */
	public function filterByCollector($collector, $comparison = Criteria::EQUAL)
	{
		return $this
