 ...
 *
 * @method     CollectionItemQuery leftJoinCollection($relationAlias = '') Adds a LEFT JOIN clause to the query using the Collection relation
 * @method     CollectionItemQuery rightJoinCollection($relationAlias = '') Adds a RIGHT JOIN clause to the query using the Collection relation
 * @method     CollectionItemQuery innerJoinCollection($relationAlias = '') Adds a INNER JOIN clause to the query using the Collection relation
 *
 * @method     CollectionItemQuery leftJoinCollectionItemMedia($relationAlias = '') Adds a LEFT JOIN clause to the query using the CollectionItemMedia relation
 * @method     CollectionItemQuery rightJoinCollectionItemMedia($relationAlias = '') Adds a RIGHT JOIN clause to the query using the CollectionItemMedia relation
 * @method     CollectionItemQuery innerJoinCollectionItemMedia($relationAlias = '') Adds a INNER JOIN clause to the query using the CollectionItemMedia relation
 *
 * @method     CollectionItemQuery leftJoinCollectionItemForSale($relationAlias = '') Adds a LEFT JOIN clause to the query using the CollectionItemForSale relation
 * @method     CollectionItemQuery rightJoinCollectionItemForSale($relationAlias = '') Adds a RIGHT JOIN clause to the query using the CollectionItemForSale relation
 * @method     CollectionItemQuery innerJoinCollectionItemForSale($relationAlias = '') Adds a INNER JOIN clause to the query using the CollectionItemForSale relation
 *
 * @method     CollectionItemQuery leftJoinCollectionItemOffer($relationAlias = '') Adds a LEFT JOIN clause to the query using the CollectionItemOffer relation
 * @method     CollectionItemQuery rightJoinCollectionItemOffer($relationAlias = '') Adds a RIGHT JOIN clause to the query using the CollectionItemOffer relation
 * @method     CollectionItemQuery innerJoinCollectionItemOffer($relationAlias = '') Adds a INNER JOIN clause to the query using the CollectionItemOffer relation
 *
...
abstract class BaseCollectionItemQuery extends ModelCriteria
{
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByCollectionId($collectionId = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterBySlug($slug = null, $comparison = Criteria::EQUAL)
	{
		if (is_array($slug)) {
			if ($comparison == Criteria::EQUAL) {
				$comparison = Criteria::IN;
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByEstValue($estValue = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByPurchasedPrice($purchasedPrice = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByCurrency($currency = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByPhoto($photo = null, $comparison = Criteria::EQUAL)
	{
		if (is_array($photo)) {
			if ($comparison == Criteria::EQUAL) {
				$comparison = Criteria::IN;
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByIsForSale($isForSale = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByNumViews($numViews = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function joinCollection($relationAlias = '', $joinType = Criteria::LEFT_JOIN)
	{
	 ...
	 */
	public function useCollectionQuery($relationAlias = '', $joinType = Criteria::LEFT_JOIN)
	{
		return $this
	...
	/**
	 * Filter the query by a related CollectionItemMedia object
	 *
	 * @param     CollectionItemMedia $collectionItemMedia  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByCollectionItemMedia($collectionItemMedia, $comparison = Criteria::EQUAL)
	{
		return $this
			->addUsingAlias(CollectionItemPeer::ID, $collectionItemMedia->getCollectionItemId(), $comparison);
	}

	/**
	 * Adds a JOIN clause to the query using the CollectionItemMedia relation
	 * 
	 * @param     string $relationAlias optional alias for the relation
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function joinCollectionItemMedia($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('CollectionItemMedia');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'CollectionItemMedia');
		}
	...
	/**
	 * Use the CollectionItemMedia relation CollectionItemMedia object
	 *
	 * @see       useQuery()
	 * 
	 * @param     string $relationAlias optional alias for the relation,
	 ...
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    CollectionItemMediaQuery A secondary query class using the current class as primary query
	 */
	public function useCollectionItemMediaQuery($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		return $this
			->joinCollectionItemMedia($relationAlias, $joinType)
			->useQuery($relationAlias ? $relationAlias : 'CollectionItemMedia', 'CollectionItemMediaQuery');
	}
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByCollectionItemForSale($collectionItemForSale, $comparison = Criteria::EQUAL)
	{
		return $this
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function filterByCollectionItemOffer($collectionItemOffer, $comparison = Criteria::EQUAL)
	{
		return $this
	 ...
	 * @return    CollectionItemQuery The current query, for fluid interface
	 */
	public function joinCollectionItemOffer($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
	 ...
	 */
	public function useCollectionItemOfferQuery($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		return $this
