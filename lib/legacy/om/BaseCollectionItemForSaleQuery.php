 ...
 *
 * @method     CollectionItemForSaleQuery leftJoinCollectionItem($relationAlias = '') Adds a LEFT JOIN clause to the query using the CollectionItem relation
 * @method     CollectionItemForSaleQuery rightJoinCollectionItem($relationAlias = '') Adds a RIGHT JOIN clause to the query using the CollectionItem relation
 * @method     CollectionItemForSaleQuery innerJoinCollectionItem($relationAlias = '') Adds a INNER JOIN clause to the query using the CollectionItem relation
 *
 * @method     CollectionItemForSaleQuery leftJoinCollectionItemOffer($relationAlias = '') Adds a LEFT JOIN clause to the query using the CollectionItemOffer relation
 * @method     CollectionItemForSaleQuery rightJoinCollectionItemOffer($relationAlias = '') Adds a RIGHT JOIN clause to the query using the CollectionItemOffer relation
 * @method     CollectionItemForSaleQuery innerJoinCollectionItemOffer($relationAlias = '') Adds a INNER JOIN clause to the query using the CollectionItemOffer relation
 *
...
abstract class BaseCollectionItemForSaleQuery extends ModelCriteria
{
	 ...
	 * @return    CollectionItemForSaleQuery The current query, for fluid interface
	 */
	public function filterByIsPriceNegotiable($isPriceNegotiable = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemForSaleQuery The current query, for fluid interface
	 */
	public function filterByIsShippingFree($isShippingFree = null, $comparison = Criteria::EQUAL)
	{
	 ...
	 * @return    CollectionItemForSaleQuery The current query, for fluid interface
	 */
	public function filterByIsSold($isSold = null, $comparison = Criteria::EQUAL)
	{
		if (is_string($isSold)) {
...
} // BaseCollectionItemForSaleQuery
