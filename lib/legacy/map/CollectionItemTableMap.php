...
class CollectionItemTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.legacy.map.CollectionItemTableMap';
    ...
    $this->addRelation('CollectionItemMedia', 'CollectionItemMedia', RelationMap::ONE_TO_MANY, array('id' => 'collection_item_id', ), null, null);
