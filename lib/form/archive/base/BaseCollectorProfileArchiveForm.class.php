...
/**
 * CollectorProfileArchive form base class.
 *
 * @method CollectorProfileArchive getObject() Returns the current form's model object
 *
 * @package    CollectorsQuest
 * @subpackage form
 * @author     Collectors
 */
abstract class BaseCollectorProfileArchiveForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('collector_profile_archive[%s]');
