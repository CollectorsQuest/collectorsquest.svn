...
abstract class BaseCollectorForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'session_id'          => new sfWidgetFormPropelChoice(array('model' => 'SessionStorage', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'session_id'          => new sfValidatorPropelChoice(array('model' => 'SessionStorage', 'column' => 'id', 'required' => false)),
