...
<div class="span-18 last">
  ...
  <div class="span-17 append-bottom last">
    ...
    <fieldset>
      ...
      <?php echo nl2br(cqStatic::clean($collector_profile->getAbout(), 'a, b, u, i, strong')); ?>
    </fieldset>
    <?php endif; ?>
    ...
    <fieldset>
      ...
      <?php echo nl2br(cqStatic::clean($collector_profile->getCollections(), 'a, b, u, i, strong')); ?>
    </fieldset>
    <?php endif; ?>
    ...
    <fieldset>
      ...
      <?php echo nl2br(cqStatic::clean($collector_profile->getInterests(), 'a, b, u, i, strong')); ?>
    </fieldset>
    <?php endif; ?>
  </div>
  ...
  <div class="span-17 append-bottom last">
    <fieldset>
      ...
      <p>
        ...
        <a href="<?= url_for('@collector_by_slug?slug='.$collector->getSlug(), true); ?>" title="<?= $collector->getDisplayName(); ?>">
          <?= url_for('@collector_by_slug?slug='.$collector->getSlug(), true); ?>
        </a>
      </p>
    </fieldset>
  </div>
